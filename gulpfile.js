...
gulp.task('clean', function() {
  del(['website', 'assets/css/main.css*', 'assets/js/main*.js*']);
});

gulp.task('renameSources', function() {
  return gulp.src(['*.html', '*.php'])
    .pipe(htmlreplace({
      'js': 'https://d2axomif2iwq0z.cloudfront.net/js/main.min.js',
      'css': 'https://d2axomif2iwq0z.cloudfront.net/css/main.min.css'
    }))
