...
<?php get_header(); ?>
	...
	<div class="container home">
		...
		<div class="row justify-content-between responsivelg">
			<?php 
				$args = array( 
					'post_type' => 'product', 
					'posts_per_page' => 1, 
				...
				while ( $loop->have_posts() ) : $loop->the_post(); global $product; ?>
					<div class="item">
						<a href="<?php echo get_permalink( $loop->post->ID ) ?>" class="col-12 product" title="<?php echo esc_attr($loop->post->post_title ? $loop->post->post_title : $loop->post->ID); ?>">
							...
							<?php 
								if (has_post_thumbnail( $loop->post->ID )) {
									...
									echo '<img class="img-fluid" src="'.wc_placeholder_img_src().'" alt="Placeholder" width="300px" height="300px" />'; 
								}
							?>
